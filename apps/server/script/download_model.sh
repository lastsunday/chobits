...
mkdir -p llm || exit
# 0.6B
# mkdir -p llm/unsloth/Qwen3-0.6B-GGUF
# wget https://huggingface.co/Qwen/Qwen3-0.6B/resolve/167b8104f88905a951069f5f95f9776908da5f68/tokenizer.json -O llm/unsloth/Qwen3-0.6B-GGUF/tokenizer.json
# wget https://huggingface.co/unsloth/Qwen3-0.6B-GGUF/resolve/058b74ede71731e4a323a88d68da1386519ec6fc/Qwen3-0.6B-Q4_K_M.gguf -O llm/unsloth/Qwen3-0.6B-GGUF/model.gguf
# 1.7B
mkdir -p llm/unsloth/Qwen3-1.7B-GGUF
wget https://huggingface.co/Qwen/Qwen3-1.7B/resolve/70d244cc86ccca08cf5af4e1e306ecf908b1ad5e/tokenizer.json -O llm/unsloth/Qwen3-1.7B-GGUF/tokenizer.json
wget https://huggingface.co/unsloth/Qwen3-1.7B-GGUF/resolve/d7f544eead698dbd1f15126ef60b45a1e1933222/Qwen3-1.7B-Q4_K_M.gguf -O llm/unsloth/Qwen3-1.7B-GGUF/model.gguf
cd ..
cd ..
